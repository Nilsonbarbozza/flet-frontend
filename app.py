...
def main(page: ft.Page):
    ...
    create_button = ft.ElevatedButton(text="Enviar", height=40, width=100, bgcolor=ft.colors.BLUE_600, color="white",style=ft.ButtonStyle(
    ...
    container = ft.Container(height=8)
    list_result = ft.Text()
    list_button = ft.ElevatedButton(text="Listar Alunos", height=40, width=200, bgcolor=ft.colors.BLUE_600, color="white",style=ft.ButtonStyle(
        shape=ft.RoundedRectangleBorder(radius=12),
        padding=ft.padding.symmetric(horizontal=20, vertical=14),
        overlay_color=ft.colors.BLUE_600,
    ...
    aula_button = ft.ElevatedButton(text="Registrar", height=40, width=100, bgcolor=ft.colors.BLUE_600, color="white",style=ft.ButtonStyle(
        shape=ft.RoundedRectangleBorder(radius=12),
        padding=ft.padding.symmetric(horizontal=20, vertical=14),
        overlay_color=ft.colors.BLUE_600,
    ...
    progress_button = ft.ElevatedButton(text="Ver progresso", height=40, width=200, bgcolor=ft.colors.BLUE_600, color="white",style=ft.ButtonStyle(
        shape=ft.RoundedRectangleBorder(radius=12),
        padding=ft.padding.symmetric(horizontal=20, vertical=14),
        overlay_color=ft.colors.BLUE_600,
    ...
    update_button = ft.ElevatedButton(text="Atualizar Aluno", height=40, width=200, bgcolor=ft.colors.BLUE_600, color="white",style=ft.ButtonStyle(
        shape=ft.RoundedRectangleBorder(radius=12),
        padding=ft.padding.symmetric(horizontal=20, vertical=14),
        overlay_color=ft.colors.BLUE_600,
    ...
    email_aluno_field = ft.TextField(label="E-mail",label_style= ft.TextStyle(size=12, color="black"), border_radius=10)
    ...
    delet_button = ft.ElevatedButton(text="Deletar", height=40, width=100, bgcolor=ft.colors.RED, color="white",style=ft.ButtonStyle(
        shape=ft.RoundedRectangleBorder(radius=12),
        padding=ft.padding.symmetric(horizontal=20, vertical=14),
        overlay_color=ft.colors.BLUE_600,
